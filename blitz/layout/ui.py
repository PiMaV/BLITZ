...
class UI_MainWindow(QWidget):
    ...
    def setup_option_dock(self) -> None:
        ...
        # self.spinbox_pcacomp.setMinimum(1)
        # self.spinbox_pcacomp.setMaximum(1)
        # rosee_layout.addWidget(self.spinbox_pcacomp)
        # self.combobox_pca = QComboBox()
        # self.combobox_pca.addItem("Reconstruction")
        # self.combobox_pca.addItem("Components")
        # rosee_layout.addWidget(self.combobox_pca)
        self.checkbox_rosee = QCheckBox("Show")
        rosee_layout.addWidget(self.checkbox_rosee)
        self.combobox_rosee = QComboBox()
        self.combobox_rosee.addItem("horizontal")
        self.combobox_rosee.addItem("vertical")
        rosee_layout.addWidget(self.combobox_rosee)
