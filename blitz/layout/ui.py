...
class UI_MainWindow(QWidget):
    ...
    def setup_menu_and_status_bar(self) -> None:
        ...
        self.action_open_file.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_FileIcon))
        self.action_open_folder = file_menu.addAction("Open Folder")
        self.action_open_folder.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DirIcon))
        self.action_load_tof = file_menu.addAction("Load TOF")
        file_menu.addSeparator()
        self.action_export = file_menu.addAction("Export")
        self.action_export.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogSaveButton))
        file_menu.addSeparator()
        self.action_restart = file_menu.addAction("Restart")
        self.action_restart.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
    ...
    def setup_lut_dock(self) -> None:
        ...
        self.button_load_lut.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogOpenButton))
        self.button_export_lut = QPushButton("Export")
        self.button_export_lut.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogSaveButton))
    ...
    def setup_option_dock(self) -> None:
        ...
        self.button_open_file.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_FileIcon))
        ...
        self.button_open_folder.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DirIcon))
        ...
        self.button_crop.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogApplyButton))
        ...
        self.button_apply_mask.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogApplyButton))
        self.button_reset_mask = QPushButton("Reset")
        self.button_reset_mask.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogResetButton))
        self.button_reset_mask.setStyleSheet(get_style("button_danger"))
        ...
        self.button_reset_range.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogResetButton))
        self.button_reset_range.setStyleSheet(get_style("button_danger"))
        ...
        self.button_connect.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DriveNetIcon))
        self.button_disconnect = QPushButton("Disconnect")
        self.button_disconnect.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DialogCancelButton))
        self.button_disconnect.setStyleSheet(get_style("button_danger"))
