...
- **Hillshade Relief Visualization** — Lambertian shading from height fields (`∇z`, azimuth / elevation / Z-factor); Preview overlay only (analysis stays on height). Optional 30° azimuth Pre-cache. No Apply-replace-stack.
